...
class UserServices{
    ...
    async update(req: Request, res:Response): Promise<Response>{
        ...
        try{
            ...
            users.picture = cloudinaryResponse.url
    ...
    async checking(req: Request, res: Response){
        try{
            ...
            // console.log('ini login session di check',loginSession)
            ...
            const user = await this.userRepository.findOne(
                {
                    ...
                    select: ["id", "email", "username", "full_name", "description",  "password", "picture"]
                }
            )
